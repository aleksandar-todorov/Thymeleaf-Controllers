...
import org.softuni.residentevil.annotations.PresentOrPastDate;
import org.softuni.residentevil.annotations.ValidateEnum;
...
public class VirusAddBindingModel {
    ...
    @NotNull
    @ValidateEnum(targetClassType = Creator.class)
    ...
    @NotNull(message = "You should choose at least 1 Capital")
